	...
	return (
		<div className="mobile-buttons">
			<div className="button-row">
				<button type="button" onClick={() => props.handleMobileButton(PlayerResultEnum.ARROW_UP)}>
					UP
				</button>
			</div>
			<div className="button-row">
			...
			<div className="button-row">
				<button type="button" onClick={() => props.handleMobileButton(PlayerResultEnum.ARROW_DOWN)}>
					DOWN
				</button>
			</div>
		</div>
