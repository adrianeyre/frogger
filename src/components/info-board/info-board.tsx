		...
		<div className="info-board" style={styleInfoBoard()}>
			...
			<div className="info-board-instructions">
				<ul>
					...
					<li>
						You must guide Frogger to each of the five empty slots at the top of the screen in order to advance to the
						next stage.
					</li>
					...
					<li>
						You must not fall in the water on the way to one of the slots at the top. Ride the turtles and logs to the
						top, but don't get pulled off the side of the screen.
					</li>
					<li>Beware of diving turtles. If Frogger is on them when they dive, he loses a life.</li>
					<li>
						Avoid crocodile mouths, catch flies in the slots for bonus points, and bring the lady frog to your home for
						more bonus points.
					</li>
				</ul>
			</div>
