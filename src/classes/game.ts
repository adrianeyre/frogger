...
export default class Game implements IGame {
	...
	public handleInput = (playerResult: PlayerResultEnum): void => {
		switch (playerResult) {
			...
			case PlayerResultEnum.HOME5:
				this.playerHome(playerResult); break;
	...
	private playerHome = (homePosition: number): void => {
